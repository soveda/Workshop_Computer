# Gnarly C1ZZL3 8mu Version Card Guide

Gnarly C1ZZL3 8mu Version is a separate, no-Turing dual-oscillator
phase-distortion synth for the Music Thing Modular Workshop Computer. It keeps
Gnarly's recipe wave banks, named sound presets, and CZ patch import support,
then adds direct Music Thing 8mu control of the six envelope lanes.
